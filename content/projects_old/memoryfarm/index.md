...
[extra]
local_image = "projects_old/memoryfarm/git-sumi_logo.png"
social_media_card = "social_cards/projects_git-sumi.jpg"
canonical_url = "https://osc.garden/projects/git-sumi/"
+++

**Memory Farm** is an attempt to rewrite my old game with the same name created in 2012 with processingjs now using p5.js and Typescript, for fun and learning purposes ([play in web browser](./playablegames/giftowerdefense/index.html)).
