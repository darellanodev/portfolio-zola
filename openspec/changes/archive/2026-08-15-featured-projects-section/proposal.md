...
- Rename the home section title from "Latest projects" to "Projects".
- Add a subtitle phrase "Projects I'm building to learn, contribute to the community and enjoy the process." directly below the "Projects" heading, before the project listing.
...
- `featured-projects-section`: The home page renders a "Projects" section with a subtitle phrase and the project listing laid out as a two-column grid of stacked cards that collapses to one column on narrow screens.
...
- `content/_index.md`: home section title changed to "Projects".
