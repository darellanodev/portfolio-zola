# gradient-color-styling Specification

## Purpose

Defines the theme-aware `.gradient-color` styling: darker gradient colors in light mode, pastel colors in dark mode, no text-stroke, applied to all existing usages.
