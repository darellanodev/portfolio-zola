...
Render a visual badge on every project display that shows the project's category, so visitors can identify at a glance what kind of project they are looking at. Badges use a distinct color per category and never appear on pages without a category.
