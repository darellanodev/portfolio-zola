...
Ensure the home page presents its project listing as a "Projects" section with a subtitle phrase and a responsive two-column grid of stacked cards, without affecting the blog listing layout.
